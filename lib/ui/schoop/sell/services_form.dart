                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(hintText: "Nama Jasa"),
                          ),
                          TextField(
                            style: GoogleFonts.poppins(),
                            controller: priceController,
                            decoration: InputDecoration(hintText: "Harga Jasa"),
                            keyboardType: TextInputType.number,
                          ),
                          TextField(
                            style: GoogleFonts.poppins(),
                            controller: stockController,
                            decoration: InputDecoration(hintText: "Stok Jasa"),
                            keyboardType: TextInputType.number,
                          ),
                          TextField(
                            style: GoogleFonts.poppins(),
                            ...
                            decoration:
                                InputDecoration(hintText: "Deskripsi Jasa"),
                          ),
                          TextField(
                            style: GoogleFonts.poppins(),
                            ...
                            child: RaisedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (uploadImage().toString().isEmpty) {
                                    imageController.text = "Gambar Jasa";
                                  } else if (uploadImage()
                                      .toString()
                                      .isNotEmpty) {
                                    setState(() {
