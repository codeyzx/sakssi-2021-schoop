...
import 'package:schoop/ui/schoop/search/search_page_services.dart';
...
class ServiceItemsPage extends StatefulWidget {
  const ServiceItemsPage({Key? key}) : super(key: key);

  @override
  _ServiceItemsPageState createState() => _ServiceItemsPageState();
}
          ...
          child: Scaffold(
            ...
            body: GestureDetector(
              ...
              child: CustomScrollView(
                slivers: [
                  SliverAppBar(
                    backgroundColor: HexColor("#0C4271"),
                    leading: IconButton(
                      onPressed: () {},
                      icon: Icon(
