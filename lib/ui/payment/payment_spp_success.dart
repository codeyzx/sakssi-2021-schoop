...
class SppSuccessPage extends StatefulWidget {
  final String paymentMethod;
  const SppSuccessPage(this.paymentMethod, {Key? key}) : super(key: key);

  @override
  _SppSuccessPageState createState() => _SppSuccessPageState(paymentMethod);
}

class _SppSuccessPageState extends State<SppSuccessPage> {
  final String _paymentMethod;
  _SppSuccessPageState(this._paymentMethod);
  @override
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Center(
                          child: Text(
                        "Terima kasih sudah membayar spp di Schoop",
                        style: titleSuccess,
