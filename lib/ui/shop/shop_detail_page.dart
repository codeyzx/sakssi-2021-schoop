...
import 'package:schoop/ui/shop/shop_transaction_page.dart';
...
class ShopDetailPage extends StatefulWidget {
  ...
  final String desc;
  const ShopDetailPage(this.id, this.image, this.name, this.price, this.stock,
      this.seller, this.sellerNumber, this.desc,
      {Key? key})
      : super(key: key);
