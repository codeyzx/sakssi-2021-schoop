...
class ShopSuccessPage extends StatefulWidget {
  final String sellerName;
  final String sellerNumber;
  final String orderMethod;
  final String paymentMethod;
  final String location;
  const ShopSuccessPage(this.sellerName, this.sellerNumber, this.orderMethod,
      this.paymentMethod, this.location,
      {Key? key})
      : super(key: key);

  @override
  _ShopSuccessPageState createState() => _ShopSuccessPageState(
      sellerName, sellerNumber, orderMethod, paymentMethod, location);
}

class _ShopSuccessPageState extends State<ShopSuccessPage> {
  final String _sellerName;
  final String _sellerNumber;
  final String _orderMethod;
  final String _paymentMethod;
  final String _location;
  _ShopSuccessPageState(this._sellerName, this._sellerNumber, this._orderMethod,
